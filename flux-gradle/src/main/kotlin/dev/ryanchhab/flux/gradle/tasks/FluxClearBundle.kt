 ...
 * `finalizedBy` (matching how [dev.ryanchhab.flux.gradle.FluxPlugin] already wires [FluxSyncBaseline]) rather
...
abstract class FluxClearBundle : DefaultTask() {
     ...
     *  might throw at configuration time) — see [dev.ryanchhab.flux.gradle.FluxPlugin]'s wiring: adb
