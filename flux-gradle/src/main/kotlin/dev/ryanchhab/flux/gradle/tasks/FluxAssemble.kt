...
import dev.ryanchhab.flux.gradle.LiveTuneOutcome
import dev.ryanchhab.flux.gradle.LiveTuneOutcomeIO
import dev.ryanchhab.flux.gradle.TierDetector
import dev.ryanchhab.flux.gradle.TierOutcome
import dev.ryanchhab.flux.gradle.TierOutcomeIO
...
abstract class FluxAssemble : DefaultTask() {
    ...
    /** [dev.ryanchhab.flux.gradle.LiveTuneDetector]'s own snapshot dir -- separate from [tierStateDir]. */
    @get:Internal
    ...
    fun generate() {
        ...
        pkgDir.resolve("__FluxVersion.java").writeText(
            ...
            // Generated by dev.ryanchhab.flux — do not edit, do not commit.
