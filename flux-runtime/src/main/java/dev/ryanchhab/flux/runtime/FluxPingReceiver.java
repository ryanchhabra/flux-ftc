...
/**
 * Answers {@code dev.ryanchhab.flux.PING} with the runtime's version, so the desktop can tell whether
 ...
 * {@code adb shell dumpsys package} for a {@code dev.ryanchhab.flux.RELOAD} receiver. That check is a
...
public final class FluxPingReceiver {
    ...
    public static final String ACTION_PING = "dev.ryanchhab.flux.PING";
