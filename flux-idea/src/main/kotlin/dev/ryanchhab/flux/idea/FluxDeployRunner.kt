...
object FluxDeployRunner {
     ...
     *   `dev.ryanchhab.flux` -- CONTRACT.md doesn't fix a module name, and requiring the user to know
    ...
    fun run(
        ...
        val commandLine = if (wrapper.isFile) {
            ...
            // safety net for other projects applying dev.ryanchhab.flux, not the common case.
