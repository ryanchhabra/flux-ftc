 ...
 *      - a module applying `dev.ryanchhab.flux` is a certain match — that is literally the project Flux
...
object GradleProjectLocator {
    ...
    /**
     * Does any module in this build apply `dev.ryanchhab.flux`? Checked by text rather than by asking
     ...
     *
     * A plain `text.contains("dev.ryanchhab.flux")` is not good enough, and this was caught by actually
     * running the search over this repo: it matched all three builds, because
     *   - `flux-gradle/build.gradle.kts` **registers** the id  -> `id = "dev.ryanchhab.flux"`
